 ...
 * 
 */
(function(a){a.fn.tamper=function(d,c){var e=a(this),b=a(d);c=c||"Are you sure? \nDoing so will lose any pending changes.";e.data("altered",false);b.data("tamper",{watch:watchName,message:c});if(typeof b.attr("onclick")=="function"){var h=b.attr("onclick");b.removeAttr("onclick")}e.keypress(function(){a(this).data("altered",true)});b.click(function(){var f=true,g=a(this).data("tamper").watch;if(g=a(g).data("altered")||false){var i=a(this).data("tamper").message;if(confirm(i)===false)f=false}f===true| g===false&&h&&b.attr("onclick",h);return f})};a.fn.tamperAlert=function(d){var c=a(this);d=d||"Are you sure? \nDoing so will lose any pending changes.";c.data("tamper",{message:d});c.click(function(){var e=true,b=a(this).data("tamper").message;if(a(this).data("altered"))if(confirm(b)===false)e=false;return e})};a.fn.tamperFlag=function(){a(this).data("altered",true)}})(jQuery);