 ...
 * 
 */
jQuery.tamper=function(a,e,c){var d=$(a),b=$(e);c=c||"Are you sure? \nDoing so will lose any pending changes.";if(d.length>0){d.data("altered",false);b.data("tamper",{watch:a,message:c});if(typeof b.attr("onclick")=="function"){var h=b.attr("onclick");b.removeAttr("onclick")}d.keypress(function(){$(this).data("altered",true)});b.click(function(){var f=true,g=$(this).data("tamper").watch;if(g=$(g).data("altered")||false){var i=$(this).data("tamper").message;if(confirm(i)===false)f=false}f===true|g=== false&&h&&b.attr("onclick",h);return f})}};jQuery.tamperAlert=function(a,e){var c=$(a);e=e||"Are you sure? \nDoing so will lose any pending changes.";if(c.length>0){c.data("tamper",{message:e});c.click(function(){var d=true,b=$(this).data("tamper").message;if($(this).data("altered"))if(confirm(b)===false)d=false;return d})}};jQuery.tamperFlag=function(a){a=$(a);a.length>0&&a.data("altered",true)};